...
use Modules\Activitylog\Exceptions\CouldNotLogActivity;
...
class ActivityLogger
{
    ...
    /** @var \Modules\Activitylog\ActivityLogStatus */
    protected $logStatus;
     ...
     * @param \Illuminate\Database\Eloquent\Model|int|string $modelOrId
     *
     * @throws \Modules\Activitylog\Exceptions\CouldNotLogActivity
     *
    ...
    protected function replacePlaceholders(string $description, Activitylog $activity): string
    {
